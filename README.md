...
![GitHub stars](https://img.shields.io/github/stars/neopen/standup-reminder-clock/stargazers)
...
- 🔔 **通知权限测试** - 一键测试桌面通知是否正常工作

### 弹框特性
- 🖥️ **应用内全屏遮罩** - 提醒时全屏覆盖应用窗口
...
### v0.4 (2026-04-14)
- ✨ 应用名称更新为「起来走走」
- ✨ 新增窗口自动前置功能（PakePlus/Electron）
- ✨ 新增自动关闭提示弹框（3秒自动关闭 + 进度条）
- ✨ 新增通知权限测试按钮
- 🎨 优化锁屏弹框全屏覆盖样式
- 🎨 优化提醒频率输入框步长为 10 分钟
- 🐛 修复启动按钮无响应问题
