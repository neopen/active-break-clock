const AutoLaunchModule = (function () {
    let _logger = typeof Logger !== 'undefined' ? Logger.createLogger('AutoLaunch') : console;
    ...
    async function setEnabled(enabled) {
        ...
        try {
            ...
            _logger.info('Auto launch setting saved:', enabled);
            return true;
        } catch (e) {
            _logger.error('Failed to set auto launch:', e);
            return false;
        }
    }
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = AutoLaunchModule;
}
if (typeof window !== 'undefined') {
    window.AutoLaunchModule = AutoLaunchModule;
}